...
from optimize.single.optimize_vae_model_aware import optimize
from optimize.distributed.optimize_distributed_vae_model_aware import optimize_distributed
