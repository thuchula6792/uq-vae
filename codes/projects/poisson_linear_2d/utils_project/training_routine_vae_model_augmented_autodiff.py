...
from optimize.single.optimize_vae_model_augmented_autodiff import optimize
from optimize.distributed.optimize_distributed_vae_model_augmented_autodiff import\
...
from utils_project.solve_fem_poisson_heat_linear_assembled import SolveFEMPoissonHeatLinearAssembled
...
def training(hyperp, options, filepaths,
    ...
    #=== Load FEM Matrices ===#
    forward_matrix, mass_matrix, load_vector = load_fem_matrices_tf(options, filepaths)

    #=== Construct Forward Model ===#
    forward_model = SolveFEMPoissonHeatLinearAssembled(options, filepaths,
