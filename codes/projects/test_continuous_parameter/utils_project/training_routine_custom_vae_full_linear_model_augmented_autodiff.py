...
from optimize.optimize_custom_vae_full_linear_model_augmented_autodiff import optimize
from optimize.optimize_distributed_custom_vae_full_linear_model_augmented_autodiff import\
...
def trainer_custom(hyperp, options, filepaths,
    ...
    forward_model_solve = forward_model.continuous_linear
