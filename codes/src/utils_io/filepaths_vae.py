...
generated by the strings specified in the project_paths instance of the
FilePathsProject class as well as the data stored in the hyperp and options dictionaries.
